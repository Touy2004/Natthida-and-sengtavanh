...
public class Seven extends JFrame implements ActionListener {
    ...
    Seven() {
        ...
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/Seven.jpg"));
        Image p2 = p1.getImage().getScaledInstance(350, 350, Image.SCALE_DEFAULT);
        ...
        JLabel l2 = new JLabel("  VILLAIN HYDRA EAU DE PARFUM");
        l2.setFont(new Font("Tahoma", Font.BOLD, 20));
        l2.setBounds(5, 470, 550, 25);
        panel.add(l2);

        JLabel a3 = new JLabel("100mg/ml");
        a3.setForeground(new Color(0, 0, 153));
        a3.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a3.setBounds(16, 500, 150, 45);
        panel.add(a3);

        JLabel a2 = new JLabel("$" + 9.08);
        a2.setForeground(new Color(0, 0, 153));
        a2.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a2.setBounds(440, 500, 150, 45);
        panel.add(a2);

        JLabel l3 = new JLabel("   Proud, Powerful And Unique, The Macho Scent Of Villain Hydra Is Made For  ");
        l3.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel(
                "The Rebel In You Who Knows How To Go Out Strong And Make It Last For ");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(7, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("Long. While The Zesty Fragrance Of Fresh Bergamot,Lemon And Patchouli ");
        l5.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l5.setBounds(7, 620, 570, 45);
        panel.add(l5);

        JLabel l6 = new JLabel("Let Your Unpredictability And Excitement Shine. ");
