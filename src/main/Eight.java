...
public class Eight extends JFrame implements ActionListener {
    ...
    Eight() {
        ...
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/eight.jpg"));
        Image p2 = p1.getImage().getScaledInstance(380, 450, Image.SCALE_DEFAULT);
        ...
        JLabel l2 = new JLabel("  Chloe Eau de Parfum");
        l2.setFont(new Font("Tahoma", Font.BOLD, 20));
        l2.setBounds(5, 470, 550, 25);
        panel.add(l2);

        JLabel a3 = new JLabel("100mg/ml");
        a3.setForeground(new Color(255, 178, 102));
        a3.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a3.setBounds(16, 500, 150, 45);
        panel.add(a3);

        JLabel a2 = new JLabel("$" + 79.08);
        a2.setForeground(new Color(255, 178, 102));
        a2.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a2.setBounds(440, 500, 150, 45);
        panel.add(a2);

        JLabel l3 = new JLabel("    Was launched in 2008. Chloe Eau de Parfum was created by Amandine ");
        l3.setFont(new Font("Tahoma", Font.ITALIC, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel(
                "Clerc-Marie and Michel Almairac. Top notes are Peony, Litchi and Freesia; ");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(7, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("middle notes are Rose, Lily-of-the-Valley and Magnolia; base notes are ");
        l5.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l5.setBounds(7, 620, 570, 45);
        panel.add(l5);

        JLabel l6 = new JLabel("Virginia Cedar and Amber.");
