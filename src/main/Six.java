...
public class Six extends JFrame implements ActionListener {
    ...
    Six() {
        ...
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/Six.jpg"));
        ...
        JLabel l2 = new JLabel("  DIOR SAUVAGE EAU DE PARFUM");
        ...
        JLabel a2 = new JLabel("$" + 132.72);
        a2.setForeground(new Color(0, 0, 102));
        a2.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a2.setBounds(440, 500, 150, 45);
        panel.add(a2);

        JLabel l3 = new JLabel("   The powerful freshness of Sauvage exudes new sensual and mysterious ");
        l3.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel(
                "facets, amply renewing itself with the signature of an ingenious composition. ");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(7, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("Mixed with the coolness of the night, the burning desert air exudes ");
        l5.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l5.setBounds(7, 620, 570, 45);
        panel.add(l5);

        JLabel l6 = new JLabel("profound fragrances.");
