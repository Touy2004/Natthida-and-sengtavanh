...
public class Ten extends JFrame implements ActionListener {
    ...
    Ten() {
        ...
        setLayout(null);
        setBounds(390, 150, 550, 850);

        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        setContentPane(panel);
        panel.setLayout(null);
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/ten.jpg"));
        Image p2 = p1.getImage().getScaledInstance(350, 400, Image.SCALE_DEFAULT);
        ...
        JLabel l2 = new JLabel("  Chanel Bleu De Chanel EAU DE PARFUM SPRAY");
        l2.setFont(new Font("Tahoma", Font.BOLD, 20));
        l2.setBounds(5, 470, 550, 25);
        panel.add(l2);

        JLabel a3 = new JLabel("100mg/ml");
        a3.setForeground(new Color(0, 0, 102));
        a3.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a3.setBounds(16, 500, 150, 45);
        panel.add(a3);

        JLabel a2 = new JLabel("$" + 186.12);
        a2.setForeground(new Color(0, 0, 102));
        a2.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a2.setBounds(440, 500, 150, 45);
        panel.add(a2);

        JLabel l3 = new JLabel("   An ode to masculine freedom expressed in an aromatic-woody fragrance with ");
        l3.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel(
                "captivating trail. A timeless scent housed in a bottle of deep and mysterious blue");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(7, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("   BLEU DE CHANEL is presented here in an eau de parfum with an exquisitely ");
        l5.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l5.setBounds(7, 620, 570, 45);
        panel.add(l5);

        JLabel l6 = new JLabel("pronounced scent that reveals a determined spirit.");
        l6.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l6.setBounds(7, 650, 570, 45);
        panel.add(l6);
