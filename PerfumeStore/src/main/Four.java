...
public class Four extends JFrame implements ActionListener {
    ...
    Four() {
        ...
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/Four.jpg"));
        ...
        JLabel l2 = new JLabel("  JO MALONE Peony & Blush Suede");
        ...
        JLabel l3 = new JLabel(
                "  Peonies in voluptuous bloom. Flirtatious with juicy red apple and the opulence ");
        l3.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel("of jasmine,rose and gillyflower. Mingling with the sensuality of soft,blush suede.");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(11, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("Luxurious and seductive.");
