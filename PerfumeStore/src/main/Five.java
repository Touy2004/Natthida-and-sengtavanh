...
public class Five extends JFrame implements ActionListener {
    ...
    Five() {
        ...
        setLayout(null);
        setBounds(690, 150, 550, 800);

        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        setContentPane(panel);
        panel.setLayout(null);
        ImageIcon p1 = new ImageIcon(ClassLoader.getSystemResource("icons/Five.jpg"));
        Image p2 = p1.getImage().getScaledInstance(450, 350, Image.SCALE_DEFAULT);
        ...
        JLabel l2 = new JLabel("  Chanel No 5 Eau de Parfum");
        ...
        JLabel a2 = new JLabel("$" + 148.50);
        a2.setForeground(new Color(255, 204, 51));
        a2.setFont(new Font("Tahoma", Font.TYPE1_FONT, 20));
        a2.setBounds(440, 500, 150, 45);
        panel.add(a2);

        JLabel l3 = new JLabel(
                "   Chanel No 5 Eau de Parfum was launched in 1986. The nose behind this");
        l3.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l3.setBounds(10, 560, 550, 45);
        panel.add(l3);

        JLabel l4 = new JLabel(
                "fragranceis Jacques Polge. Top notes are Aldehydes, Ylang-Ylang, Neroli,");
        l4.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l4.setBounds(7, 590, 550, 45);
        panel.add(l4);

        JLabel l5 = new JLabel("Bergamot and Peach; middle notes are Iris,Jasmine, Rose and Lily-of-the-Valley");
        l5.setFont(new Font("Tahoma", Font.PLAIN, 15));
        l5.setBounds(7, 620, 570, 45);
        panel.add(l5);

        JLabel l6 = new JLabel("base notes are Sandalwood, Vanilla, Oakmoss, Patchouli and Vetiver. ");
